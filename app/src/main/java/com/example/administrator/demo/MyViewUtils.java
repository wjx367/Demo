...
public class MyViewUtils {
	 ...
	 *            视图控件的ID
	 */
	public static void bindClickListenerOnViews(Activity activity, OnClickListener clickListener, int... viewIds) {
		View view = null;
		for (int id : viewIds) {
	 ...
	 *            视图控件的ID
	 */
	public static void bindClickListenerOnViews(View containerView, OnClickListener clickListener, int... viewIds) {
		View view = null;
		for (int id : viewIds) {
	 ...
	 *            点击事件监听器
	 */
	public static void bindClickListenerOnViews(Activity activity, OnClickListener clickListener, Set<Integer> idSet) {
		View view = null;
		for (int id : idSet) {
			view = activity.findViewById(id);
			if (view != null) {
	 ...
	 *            视图控件数组
	 */
	public static void bindClickListenerOnViews(OnClickListener clickListener, View... views) {
		for (View view : views) {
			if (view != null) {
				view.setOnClickListener(clickListener);
			} else {
	...
	public static void hideViews(View containerView, int... viewIds) {
		View view = null;
		for (int id : viewIds) {
			view = containerView.findViewById(id);
			if (view != null) {
	 ...
	 *            视图控件数组
	 */
	public static void hideViews(View... vies) {
		for (View view : vies) {
			if (view != null) {
				view.setVisibility(View.GONE);
			} else {
