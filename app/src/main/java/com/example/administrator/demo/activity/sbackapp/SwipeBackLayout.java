...
public class SwipeBackLayout extends FrameLayout {
     ...
     * callback's
     * {@link SwipeBackViewDragHelper.imid.swipebacklayout.lib.ViewDragHelper.Callback#onEdgeTouched(int, int)}
     * and
     * {@link SwipeBackViewDragHelper.imid.swipebacklayout.lib.ViewDragHelper.Callback#onEdgeDragStarted(int, int)}
