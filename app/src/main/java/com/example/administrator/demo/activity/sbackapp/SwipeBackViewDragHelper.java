...
package com.example.administrator.demo.activity.sbackapp;
...
public class SwipeBackViewDragHelper {
     ...
     * callback's
     * {@link me.imid.swipebacklayout.lib.SwipeBackViewDragHelper.Callback#onEdgeTouched(int, int)}
     * and
     * {@link me.imid.swipebacklayout.lib.SwipeBackViewDragHelper.Callback#onEdgeDragStarted(int, int)}
     ...
     * {@link me.imid.swipebacklayout.lib.SwipeBackViewDragHelper.Callback#tryCaptureView(android.view.View, int)}
     ...
     * {@link me.imid.swipebacklayout.lib.SwipeBackViewDragHelper.Callback#getOrderedChildIndex(int)}
     * .
     *
     * @param x X position to test in the parent's coordinate system
     * @param y Y position to test in the parent's coordinate system
